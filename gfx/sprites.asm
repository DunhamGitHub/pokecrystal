...
ChrisSpriteGFX::               INCBIN "gfx/sprites/blue.2bpp"
ChrisBikeSpriteGFX::           INCBIN "gfx/sprites/bird.2bpp"
...
KrisSpriteGFX::                INCBIN "gfx/sprites/misty.2bpp"
KrisBikeSpriteGFX::            INCBIN "gfx/sprites/bird.2bpp"
